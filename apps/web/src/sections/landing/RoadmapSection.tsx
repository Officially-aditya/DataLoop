...
const postMvpPillars = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "LoRA adapter jobs auto-dispatched to 0G Compute on threshold"
    ],
    accent: "green"
  },
  {
          ...
          <div className="roadmap-announcement">
            <div className="roadmap-announcement-header">
              ...
              <p className="roadmap-announcement-lead">
                ...
                transform Neura from a labeling platform into a permissionless data economy on 0G.
              </p>
            </div>
            ...
            <div className="roadmap-horizon">
              ...
              <p className="roadmap-horizon-footnote">
                ...
                and every dataset becomes a tradeable, provenance-verified asset on 0G.
              </p>
            </div>
          </div>
        </Reveal>
