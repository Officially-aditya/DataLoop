...
describe("ArtifactRegistry", function () {
  ...
  it("creates an artifact id and stores the 0G artifact reference on-chain", async function () {
    const { contract, creator } = await deployFixture();
    const metadataURI = "0g://artifact-metadata/excel.json";
    const storageURI = "0g://artifact-marketplace/excel.md";
  ...
  it("lets only the creator update an artifact version", async function () {
    ...
    await expect(
      contract
        ...
        .updateArtifact(
          artifactId,
          "0g://artifact-metadata/excel-v2.json",
          id("excel-metadata-v2"),
          "0g://artifact-marketplace/excel-v2.md",
    ...
    expect(artifact.storageURI).to.equal("0g://artifact-marketplace/excel-v2.md");
  });
});
